...
bolsistas = [
    ...
    {'nome': 'Matheus dos Santos Freitas', 'descricao': 'BCC 013', 'foto': 'matheus_dos_santos_freitas.jpg', 'contato': 'mdossantosfreitas'},
    ...
    {'nome': 'Renan Peixoto da Silva', 'descricao': 'BCC 012', 'foto': 'renan_peixoto_da_silva.jpg', 'contato': 'renanpeixotox'},
...
def equipe(request):
    context_dictionary = {'pagina': 'equipe',
                          ...
                          'bolsistas': bolsistas,
                          'naoBolsistas': nao_bolsistas,
                          'voluntarios': voluntarios,
                          'exMembros': ex_membros,
